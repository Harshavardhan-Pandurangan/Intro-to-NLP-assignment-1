...
if lm_type == 'n':
    ...
    tokenizer = Tokenizer(sentence=test_sentence)
    ...
    print('Perplexity of given sentence', ngram.perplexity(tokens))
    ...
    #     token = tokens[i:i+3]
    #     if tuple(token[:-1]) in ngram.probabilities_gt:
    #         if token[-1] in ngram.probabilities_gt[tuple(token[:-1])]:
    #             prob *= ngram.probabilities_gt[tuple(token[:-1])][token[-1]]
    #         else:
    #             prob *= 10**-5
    #     else:
    #         prob *= 10**-5
